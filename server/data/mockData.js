// Server Data for InstaPulse AI
// Supports clearing demo data and adding custom user account profiles.

export const PROFILES = {
  custom: {
    id: "custom",
    name: "My Instagram Profile",
    handle: "@my_instagram_profile",
    avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&q=80",
    category: "Creator & Personal",
    verified: false,
    totalFollowers: 0,
    ...
    audience: {
      topCountries: [
        { name: "India", pct: 64.2 },
        { name: "United States", pct: 18.5 },
        { name: "United Kingdom", pct: 7.3 }
      ],
      ageDistribution: [
        { age: "18-24", pct: 45.2 },
        { age: "25-34", pct: 38.1 }
      ],
      gender: { male: 54.0, female: 44.5, other: 1.5 },
      bestTime: { day: "Thursday", time: "8:00 PM IST" }
    },
    posts: []
  }
};
